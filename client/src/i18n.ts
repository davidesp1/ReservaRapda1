...
const resources = {
  pt: {
    translation: {
      ...
      "AuthenticBrazilianCuisineWaitingForYou": "Sabores autênticos da culinária brasileira esperando por você.",
      ...
      "SupportTeamWillContactYou": "Nossa equipe de suporte entrará em contato com você em breve.",
      "FrequentlyAskedQuestions": "Perguntas Frequentes",
      "FindAnswersToCommonQuestions": "Encontre respostas para perguntas comuns",
      "MoreQuestionsText": "Ainda tem perguntas? Nossa equipe está pronta para ajudar.",
      ...
      "LunchTime": "Almoço",
      "DinnerTime": "Jantar",
      "EventHoursQuestion": "Quais são os horários de funcionamento do restaurante durante o evento?",
      "EventHoursAnswer": "O restaurante estará aberto durante todos os dias do evento (29 de maio a 1 de junho de 2025). Servimos almoço das 12h às 15h e jantar das 19h às 23h.",
      "ReservationCancellationQuestion": "Como posso cancelar ou modificar minha reserva?",
      "ReservationCancellationAnswer": "Você pode cancelar ou modificar sua reserva através da seção 'Reservas' em seu painel do cliente até 24 horas antes do horário reservado. Para alterações em um prazo menor, entre em contato diretamente com nossa equipe.",
      "DietaryRestrictionsQuestion": "Vocês acomodam restrições alimentares especiais?",
      "DietaryRestrictionsAnswer": "Sim! Temos opções vegetarianas, veganas, sem glúten e sem lactose em nosso cardápio. Recomendamos informar suas restrições alimentares no momento da reserva para que possamos preparar sua experiência da melhor forma possível.",
      "LargeGroupsQuestion": "É possível fazer reservas para grupos grandes?",
      "LargeGroupsAnswer": "Sim, podemos acomodar grupos de até 20 pessoas. Para grupos maiores, recomendamos entrar em contato com antecedência para garantir que possamos oferecer o melhor serviço.",
      "PaymentMethodsQuestion": "Quais métodos de pagamento são aceitos?",
      "PaymentMethodsAnswer": "Aceitamos cartões de crédito/débito, MBWay, Multibanco e transferências bancárias. Lamentamos informar que não aceitamos cheques.",
      "ParkingQuestion": "Há estacionamento disponível próximo ao local?",
      "ParkingAnswer": "Sim, há estacionamento disponível no local do evento. Também existem opções de estacionamento público nas proximidades.",
      "ChildrenMenuQuestion": "Vocês têm menu infantil?",
      "ChildrenMenuAnswer": "Sim, oferecemos opções especiais para crianças com porções adequadas e sabores que agradam aos pequenos.",
      "AlcoholServingQuestion": "Vocês servem bebidas alcoólicas?",
      "AlcoholServingAnswer": "Sim, temos uma seleção de vinhos portugueses e brasileiros, além de caipirinhas tradicionais e outras bebidas alcoólicas. Lembramos que servimos apenas para maiores de 18 anos.",
      
      // Payment
      "SelectPaymentMethod": "Selecione o método de pagamento",
      "PaymentAmount": "Valor a pagar",
      "PaymentSettings": "Configurações de Pagamento",
      "ManageAvailablePaymentMethods": "Gerencie os métodos de pagamento disponíveis",
      ...
      "AutomaticReceiptsDescription": "Enviar recibos automaticamente para seu email após cada pagamento",
      "PaymentNotifications": "Notificações de Pagamento",
      "PaymentNotificationsDescription": "Receber notificações sobre pagamentos e status de transações",
      "SavePaymentMethods": "Salvar Métodos de Pagamento",
      "SavePaymentMethodsDescription": "Guardar informações de pagamento para uso futuro",
      ...
      "NoPaymentsMatchingSearch": "Nenhum pagamento correspondente à sua pesquisa",
      ...
      "MultibancoPaymentDescription": "Faça o pagamento usando os dados abaixo no Multibanco ou aplicativo bancário.",
  ...
  en: {
    translation: {
      ...
      "AuthenticBrazilianCuisineWaitingForYou": "Authentic Brazilian cuisine flavors waiting for you.",
      ...
      "LunchTime": "Lunch",
      "DinnerTime": "Dinner",
      "EventHoursQuestion": "What are the restaurant's operating hours during the event?",
      "EventHoursAnswer": "The restaurant will be open throughout the event (May 29 to June 1, 2025). We serve lunch from 12pm to 3pm and dinner from 7pm to 11pm.",
      "ReservationCancellationQuestion": "How can I cancel or modify my reservation?",
      "ReservationCancellationAnswer": "You can cancel or modify your reservation through the 'Reservations' section in your customer dashboard up to 24 hours before your reserved time. For changes within a shorter timeframe, please contact our team directly.",
      "DietaryRestrictionsQuestion": "Do you accommodate special dietary restrictions?",
      "DietaryRestrictionsAnswer": "Yes! We have vegetarian, vegan, gluten-free, and lactose-free options on our menu. We recommend informing us of your dietary restrictions at the time of booking so we can prepare your experience in the best possible way.",
      "LargeGroupsQuestion": "Is it possible to make reservations for large groups?",
      "LargeGroupsAnswer": "Yes, we can accommodate groups of up to 20 people. For larger groups, we recommend contacting us in advance to ensure we can provide the best service.",
      "PaymentMethodsQuestion": "What payment methods are accepted?",
      "PaymentMethodsAnswer": "We accept credit/debit cards, MBWay, Multibanco, and bank transfers. We regret to inform that we do not accept checks.",
      "ParkingQuestion": "Is there parking available near the venue?",
      "ParkingAnswer": "Yes, there is parking available at the event venue. There are also public parking options nearby.",
      "ChildrenMenuQuestion": "Do you have a children's menu?",
      "ChildrenMenuAnswer": "Yes, we offer special options for children with appropriate portions and flavors that appeal to the little ones.",
      "AlcoholServingQuestion": "Do you serve alcoholic beverages?",
      "AlcoholServingAnswer": "Yes, we have a selection of Portuguese and Brazilian wines, as well as traditional caipirinhas and other alcoholic beverages. We remind you that we only serve to those over 18 years of age.",
  ...
  es: {
    translation: {
      ...
      "AuthenticBrazilianCuisineWaitingForYou": "Auténticos sabores de la cocina brasileña esperándote.",
      ...
      "SupportTeamWillContactYou": "Nuestro equipo de soporte se pondrá en contacto con usted pronto.",
      "FrequentlyAskedQuestions": "Preguntas Frecuentes",
      "FindAnswersToCommonQuestions": "Encuentre respuestas a preguntas comunes",
      "MoreQuestionsText": "¿Todavía tiene preguntas? Nuestro equipo está listo para ayudar.",
      ...
      "LunchTime": "Almuerzo",
      "DinnerTime": "Cena",
      "EventHoursQuestion": "¿Cuáles son los horarios del restaurante durante el evento?",
      "EventHoursAnswer": "El restaurante estará abierto durante todos los días del evento (29 de mayo al 1 de junio de 2025). Servimos almuerzo de 12pm a 3pm y cena de 7pm a 11pm.",
      "ReservationCancellationQuestion": "¿Cómo puedo cancelar o modificar mi reserva?",
      "ReservationCancellationAnswer": "Puede cancelar o modificar su reserva a través de la sección 'Reservas' en su panel de cliente hasta 24 horas antes de la hora reservada. Para cambios en un plazo menor, póngase en contacto directamente con nuestro equipo.",
      "DietaryRestrictionsQuestion": "¿Acomodan restricciones dietéticas especiales?",
      "DietaryRestrictionsAnswer": "¡Sí! Tenemos opciones vegetarianas, veganas, sin gluten y sin lactosa en nuestro menú. Recomendamos informar sus restricciones dietéticas al momento de la reserva para que podamos preparar su experiencia de la mejor manera posible.",
      "LargeGroupsQuestion": "¿Es posible hacer reservas para grupos grandes?",
      "LargeGroupsAnswer": "Sí, podemos acomodar grupos de hasta 20 personas. Para grupos más grandes, recomendamos ponerse en contacto con anticipación para garantizar que podamos ofrecer el mejor servicio.",
      "PaymentMethodsQuestion": "¿Qué métodos de pago se aceptan?",
      "PaymentMethodsAnswer": "Aceptamos tarjetas de crédito/débito, MBWay, Multibanco y transferencias bancarias. Lamentamos informar que no aceptamos cheques.",
      "ParkingQuestion": "¿Hay estacionamiento disponible cerca del lugar?",
      "ParkingAnswer": "Sí, hay estacionamiento disponible en el lugar del evento. También hay opciones de estacionamiento público en las cercanías.",
      "ChildrenMenuQuestion": "¿Tienen menú infantil?",
      "ChildrenMenuAnswer": "Sí, ofrecemos opciones especiales para niños con porciones adecuadas y sabores que agradan a los pequeños.",
      "AlcoholServingQuestion": "¿Sirven bebidas alcohólicas?",
      "AlcoholServingAnswer": "Sí, tenemos una selección de vinos portugueses y brasileños, además de caipirinhas tradicionales y otras bebidas alcohólicas. Recordamos que solo servimos a mayores de 18 años.",
