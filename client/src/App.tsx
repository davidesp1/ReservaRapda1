...
import PaymentSettingsFixed from "@/pages/admin/PaymentSettingsFixed";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/admin/settings" component={PaymentSettingsFixed} />
      <Route path="/admin/payment-settings" component={PaymentSettingsFixed} />
