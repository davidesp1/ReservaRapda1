...
const RegisterModal: React.FC<RegisterModalProps> = ({ isOpen, onClose, onLoginClick }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg lg:max-w-xl max-h-[95vh] overflow-y-auto">
        <DialogHeader className="text-center">
          ...
          <DialogTitle className="text-xl sm:text-2xl lg:text-3xl font-montserrat">{t('CreateAccount')}</DialogTitle>
          <DialogDescription className="text-sm sm:text-base">{t('FillTheFormToRegister')}</DialogDescription>
        </DialogHeader>
