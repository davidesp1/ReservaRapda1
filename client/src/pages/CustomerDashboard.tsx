  ...
  const specialOffers = [
    {
      ...
      image:
        "https://storage.googleapis.com/uxpilot-auth.appspot.com/b244fcda5b-4ef65045cac5d7d21c7f.png",
    },
  ];
  ...
  const menuHighlights = [
    {
      ...
      price: 2490,
      image:
        "https://storage.googleapis.com/uxpilot-auth.appspot.com/14db3df368-c5ada7c592c7a6a484df.png",
      popular: true,
    },
    {
      id: 2,
      ...
      price: 3290,
      image:
        "https://images.unsplash.com/photo-1579366948929-444eb79881eb?q=80&w=500&auto=format&fit=crop",
      popular: false,
    },
    {
      id: 3,
      ...
      price: 1590,
      image:
        "https://images.unsplash.com/photo-1590080875238-5496b40f074c?q=80&w=500&auto=format&fit=crop",
      popular: false,
    },
    {
      id: 4,
      ...
      price: 790,
      image:
        "https://images.unsplash.com/photo-1604152135912-04a022e73f33?q=80&w=500&auto=format&fit=crop",
      popular: true,
    },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold font-montserrat mb-2">
              {t("WelcomeToOpaQueDelicia")}
            </h2>
            <p className="opacity-90">
              {t("AuthenticBrazilianCuisineWaitingForYou")}
            </p>
          </div>
          <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="mb-4 border-b border-gray-100 pb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h4 className="font-semibold text-gray-800">
                        {upcomingReservation.occasion || t("Dinner")} -{" "}
                        {t("Table")} {upcomingReservation.tableId}
                      </h4>
                      <p className="text-sm text-gray-600">
                        {upcomingReservation.date
                          ? format(
                              new Date(upcomingReservation.date),
                              "EEEE, d MMMM",
                              { locale: pt },
                            )
                  ...
                  <div className="flex space-x-2">
                    <Button
                      onClick={() =>
                        setLocation(`/reservations/${upcomingReservation.id}`)
                      }
                ...
                <div className="mt-3 flex items-center text-sm text-gray-600">
                  ...
                  <span>
                    {upcomingReservation.partySize || 4} {t("people")}
                  </span>
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="bg-brasil-yellow px-6 py-4">
            <h3 className="text-lg font-bold text-brasil-blue font-montserrat">
              {t("SpecialOffers")}
            </h3>
          </div>
          <div className="p-6">
